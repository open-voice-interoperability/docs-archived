...
* Dr. Dahl and Mr. Southern - cement basic editing timeline for Interoperability and get it on the personal calendar with corresponding dates
* Dr. Dahl and Mr. Southern - Program Management - overseeing the passage of documents and information from one group to another on the road map (calendared dates).
* Mr. Stine: will author a first draft set of requirements for the Enterprise Architect position(s) that will be circulated to the individuals on this call. Also there should be estimates associated with how much work time we think each person will occupy. (Full time? Part time? etc.) (Move quickly).
...
* Mr. Stine: ultimately needs to bring final version Mr. Wuttke for review and then to the steering committee for approval. 
...
* Mr. Epstein, Mr. Larson, Ms. Dahl: finalize terms 'mediation' and 'delegation' ASAP. 
* Dr. Larson: needs to add this as an agenda item for the Interop meeting of Tue. 10/25 - cementing this.
